...
async function main() {
  ...
  // SALES
  const salesData = [
    { code: 'BH-2411-001', date: [testYear, 11, 5], partner: 'KH001', amount: 15000000, vat: 1500000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.PAID },
    { code: 'BH-2411-002', date: [testYear, 11, 15], partner: 'KH002', amount: 12000000, vat: 1200000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.PARTIAL, paid: 6000000 },
    { code: 'BH-2411-003', date: [testYear, 11, 20], partner: 'KH003', amount: 25000000, vat: 2500000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.UNPAID },
    { code: 'BH-2412-001', date: [testYear, 12, 3], partner: 'KH001', amount: 18000000, vat: 1800000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.PAID },
    { code: 'BH-2412-002', date: [testYear, 12, 12], partner: 'KH003', amount: 30000000, vat: 3000000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.PARTIAL, paid: 15000000 },
  ];
  ...
  // PURCHASES
  const purchasesData = [
    { code: 'MH-2411-001', date: [testYear, 11, 3], partner: 'NCC001', amount: 7000000, vat: 700000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.PAID },
    { code: 'MH-2411-002', date: [testYear, 11, 18], partner: 'NCC002', amount: 4000000, vat: 400000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.PARTIAL, paid: 2000000 },
    { code: 'MH-2412-001', date: [testYear, 12, 2], partner: 'NCC001', amount: 10500000, vat: 1050000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.PAID },
    // VAT FAIL: Cash >= 20M
    { code: 'MH-2412-002', date: [testYear, 12, 10], partner: 'NCC003', amount: 25000000, vat: 2500000, method: PaymentMethod.CASH, status: PaymentStatus.PAID },
    { code: 'MH-2412-003', date: [testYear, 12, 15], partner: 'NCC002', amount: 6000000, vat: 600000, method: PaymentMethod.BANK_TRANSFER, status: PaymentStatus.UNPAID },
  ];
  ...
  // EXPENSES
  const expensesData = [
    { code: 'CP-2411-001', date: [testYear, 11, 5], amount: 3500000, vat: 350000, expenseType: ExpenseType.UTILITY },
    { code: 'CP-2411-002', date: [testYear, 11, 20], amount: 2000000, vat: 0, expenseType: ExpenseType.ADMIN_PENALTY }, // CIT ADD-BACK
    { code: 'CP-2412-001', date: [testYear, 12, 5], amount: 4200000, vat: 420000, expenseType: ExpenseType.UTILITY },
    { code: 'CP-2412-002', date: [testYear, 12, 20], amount: 8000000, vat: 800000, expenseType: ExpenseType.ENTERTAINMENT }, // CIT WARNING
    { code: 'CP-2412-003', date: [testYear, 12, 25], amount: 15000000, vat: 0, expenseType: ExpenseType.WELFARE }, // CIT WELFARE CAP
  ];
  ...
  const stockMovements = [
    { code: 'NK-2411-001', date: [testYear, 11, 1], product: 'GAO-001', type: StockMovementType.IN, qty: 200, price: 22000 },
    { code: 'XK-2411-001', date: [testYear, 11, 5], product: 'GAO-001', type: StockMovementType.OUT, qty: 50, price: 22000 },
    { code: 'NK-2412-001', date: [testYear, 12, 1], product: 'GAO-001', type: StockMovementType.IN, qty: 300, price: 23000 },
  ];
  ...
  await prisma.cITAdjustment.createMany({
    data: [
      { cit_calculation_id: citQ4.id, adjustment_type: CITAdjustmentType.ADD_BACK, category: 'ADMIN_PENALTY', description: 'Phạt ATGT', amount: 2000000 },
      { cit_calculation_id: citQ4.id, adjustment_type: CITAdjustmentType.ADD_BACK, category: 'WELFARE_EXCESS', description: 'Phúc lợi vượt quy định', amount: 5000000 },
      { cit_calculation_id: citQ4.id, adjustment_type: CITAdjustmentType.ADD_BACK, category: 'CASH_OVER_LIMIT', description: 'Chi tiền mặt trên 20tr', amount: 25000000 },
    ],
    skipDuplicates: true,
  });
